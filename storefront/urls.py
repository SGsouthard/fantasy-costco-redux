...
urlpatterns = [
    ...
    path('armor/<int:armor_id>/', views.armor_show, name='armor'),
    ...
    path('adventuregear/<int:adventuregear_id>/', views.adventuregear_show, name='adventuregear'),
    # Mount Paths
    ...
    path('mount/<int:mount_id>/', views.mount_show, name='mount'),
    # Potion Paths
    ...
    path('potion/<int:potion_id>/', views.potion_show, name='potion'),
    # Trinket Paths
    ...
    path('trinket/<int:trinket_id>/', views.trinket_show, name='trinket'),
]   